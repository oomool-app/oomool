<template>
  <div>
    <Card
      class="w-100% h-auto bg-gradient-to-t from-[#A8BDF9] to-primary border-0 rounded-xl drop-shadow-xl transition-transform transform hover:filter hover:brightness-90"
    >
      <!--진행중-->
      <div
      ...
      >
        <CardHeader>
          <div
            class="flex bg-white font-bold px-5 py-10 w-70 h-40 shadow-inner rounded-xl justify-center items-center"
          >
      ...
      <div
        ...
        @click="$router.push({ path: `final/${rooms.roomid}/result1` })"
      >
        <CardHeader>
          <div
            class="flex bg-white text-[#6D6D6D] font-bold px-5 py-10 w-70 h-40 shadow-inner rounded-xl justify-center items-center"
